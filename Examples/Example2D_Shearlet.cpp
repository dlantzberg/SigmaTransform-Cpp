...
int main( int argc , char** argv ) {
    try {
        ...
        // analyze
        ShearT( lena ); // == ShearT.analyze( lena );
        ...
        // save coefficients
        // sigma::save2file_bin( "lena_coeff.bin", ShearT.getCoeffs() );
        // Chrono.toc("saveCoeffs").tic();

        // save windows
        // sigma::save2file_bin( "lena_windows.bin", ShearT.getWindows() );
        // Chrono.toc("saveWindows").tic();

        // save reconstruction
        //sigma::save2file( "lena_rec.bin" , ShearT.getReconstruction() , sz );
